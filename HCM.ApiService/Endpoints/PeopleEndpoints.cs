...
namespace HCM.ApiService.Endpoints
{
    public static class PeopleEndpoints
    {
        public static IEndpointRouteBuilder MapPeopleEndpoints(this IEndpointRouteBuilder app)
        {
            ...
            group.MapGet("/{id:guid}", [Authorize(Roles = "HR Admin,Manager,Employee")] async (Guid id, IPeopleService service) =>
            {
            ...
            group.MapPut("/{id:guid}", [Authorize(Roles = "HR Admin")] async (Guid id, Person updated, IPeopleService service) =>
            {
